...
{
    public abstract class GranHotelKataWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GranHotelKataWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GranHotelKataWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GranHotelKataDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GranHotelKataDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GranHotelKataDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GranHotelKataDbContext, Task<T>> func)
        {
            T result;
