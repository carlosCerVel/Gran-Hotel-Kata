...
@Injectable()
export class CheckInServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    protected processNewGuestCheckIn(response: HttpResponseBase): Observable<HttpStatusCode> {
        ...
        return _observableOf<HttpStatusCode>(null as any);
    }

    /**
     * @return Success
     */
    getAvailableRooms(): Observable<RoomListItemDto[]> {
        let url_ = this.baseUrl + "/api/services/app/CheckIn/GetAvailableRooms";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<RoomListItemDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<RoomListItemDto[]>;
        }));
    }

    protected processGetAvailableRooms(response: HttpResponseBase): Observable<RoomListItemDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(RoomListItemDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return _observableOf<RoomListItemDto[]>(null as any);
    }
}

@Injectable()
export class CheckOutServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getRoomsCurrentlyOccupied(): Observable<RoomListItemDto[]> {
        let url_ = this.baseUrl + "/api/services/app/CheckOut/GetRoomsCurrentlyOccupied";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetRoomsCurrentlyOccupied(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetRoomsCurrentlyOccupied(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<RoomListItemDto[]>;
                }
            } else
    ...
    protected processGetRoomsCurrentlyOccupied(response: HttpResponseBase): Observable<RoomListItemDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class GuestCheckInRequest implements IGuestCheckInRequest {
    ...
    constructor(data?: IGuestCheckInRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GuestCheckInRequest {
        data = typeof data === 'object' ? data : {};
        let result = new GuestCheckInRequest();
        result.init(data);
        return result;
    }
...
export class RoomListItemDto implements IRoomListItemDto {
    id: number;
    roomNumber: string | undefined;

    constructor(data?: IRoomListItemDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): RoomListItemDto {
        data = typeof data === 'object' ? data : {};
        let result = new RoomListItemDto();
        result.init(data);
        return result;
    }
